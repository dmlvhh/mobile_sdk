...
//	//res1, err2 := cf.ApiRequest("/v5/ec/query/sim-data-diagnosis", &mobile_sdk.SimBasicInfoReq{
//	res1, err2 := cf.ApiRequest("/v5/ec/operate/network-speed", &mobile_sdk.SimBasicInfoReq{
//		Transid: cf.TransID,
//		Token:   res.Data,
//		//Msisdn:  "1442078069363", // 可选字段
//		Iccid: "89860837132490469069", // 可选字段
//		//Iccid: "89860837132490570000", // 可选字段
//		//Imsi: "1442078067002", // 可选字段
//		ApnName:           "CMIOT",
//		ServiceUsageState: "94",
//	})
//	if err2 != nil {
//		fmt.Printf(err2.Error())
//		return
